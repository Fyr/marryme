...
$('.fancybox').fancybox({
  ...
  helpers: {
   title: {
	...
	$('.navigation li.expandable').live('mouseover', function(){
		$(this).addClass('expanded');
		/*function hide_drop(){
			$('.moto_1').css('fontSize','33px');
			$('.navigation li.expandable').removeClass('expanded');
			$('html').unbind('touchstart',hide_drop);
		};
		$('html').bind('touchstart',hide_drop);*/
