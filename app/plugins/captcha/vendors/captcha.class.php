  ...
  ******************************************************************/
  ...
  class captcha
  {
    ...
    function captcha ($captchaStr = '')
    {
      ...
      $this->fontpath = '../plugins/captcha/webroot/fonts/';
      ...
      if ($captchaStr) {
	  	$this->CaptchaString = $captchaStr;
	  	$this->Length = strlen($this->CaptchaString);
	  } else {
	  	$this->stringGen();
	  }
    ...
    function stringGen ($length = false)
    {
	  $this->Length = (!$length) ? 6 : $length;
